...
${OBJECTDIR}/src/frontend/Raspberry\ PI/display.o: src/frontend/Raspberry\ PI/display.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/Raspberry\ PI/display.o src/frontend/Raspberry\ PI/display.c
...
${OBJECTDIR}/src/frontend/Raspberry\ PI/joystick.o: src/frontend/Raspberry\ PI/joystick.c
	${MKDIR} -p ${OBJECTDIR}/src/frontend PI
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/Raspberry\ PI/joystick.o src/frontend/Raspberry\ PI/joystick.c
...
${OBJECTDIR}/src/frontend/Raspberry\ PI/rpcontrol.o: src/frontend/Raspberry\ PI/rpcontrol.c
	${MKDIR} -p ${OBJECTDIR}/src/frontend PI
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/Raspberry\ PI/rpcontrol.o src/frontend/Raspberry\ PI/rpcontrol.c
...
${OBJECTDIR}/src/frontend/Raspberry\ PI/display_nomain.o: ${OBJECTDIR}/src/frontend/Raspberry\ PI/display.o src/frontend/Raspberry\ PI/display.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/Raspberry\ PI/display_nomain.o src/frontend/Raspberry\ PI/display.c;\
	else  \
...
${OBJECTDIR}/src/frontend/Raspberry\ PI/joystick_nomain.o: ${OBJECTDIR}/src/frontend/Raspberry\ PI/joystick.o src/frontend/Raspberry\ PI/joystick.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/Raspberry\ PI/joystick_nomain.o src/frontend/Raspberry\ PI/joystick.c;\
	else  \
...
${OBJECTDIR}/src/frontend/Raspberry\ PI/rpcontrol_nomain.o: ${OBJECTDIR}/src/frontend/Raspberry\ PI/rpcontrol.o src/frontend/Raspberry\ PI/rpcontrol.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/Raspberry\ PI/rpcontrol_nomain.o src/frontend/Raspberry\ PI/rpcontrol.c;\
	else  \
