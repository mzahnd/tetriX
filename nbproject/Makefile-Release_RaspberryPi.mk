...
LDLIBSOPTIONS=-L/usr/local/lib/ `pkg-config --libs sdl` -I/usr/local/include  
...
${OBJECTDIR}/src/backend/board/board.o: src/backend/board/board.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/board/board.o src/backend/board/board.c
...
${OBJECTDIR}/src/backend/board/pieces/piece_actions.o: src/backend/board/pieces/piece_actions.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/board/pieces/piece_actions.o src/backend/board/pieces/piece_actions.c

${OBJECTDIR}/src/backend/board/random_generator.o: src/backend/board/random_generator.c
	${MKDIR} -p ${OBJECTDIR}/src/backend/board
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/board/random_generator.o src/backend/board/random_generator.c
...
${OBJECTDIR}/src/backend/board/timer/boardTimer.o: src/backend/board/timer/boardTimer.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/board/timer/boardTimer.o src/backend/board/timer/boardTimer.c

${OBJECTDIR}/src/backend/rw/rw_ops.o: src/backend/rw/rw_ops.c
	${MKDIR} -p ${OBJECTDIR}/src/backend/rw
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/rw/rw_ops.o src/backend/rw/rw_ops.c

${OBJECTDIR}/src/backend/stats/stats_mgmt.o: src/backend/stats/stats_mgmt.c
	${MKDIR} -p ${OBJECTDIR}/src/backend/stats
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/stats/stats_mgmt.o src/backend/stats/stats_mgmt.c

${OBJECTDIR}/src/frontend/rpi/audioControl.o: src/frontend/rpi/audioControl.c
	${MKDIR} -p ${OBJECTDIR}/src/frontend/rpi
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/rpi/audioControl.o src/frontend/rpi/audioControl.c

${OBJECTDIR}/src/frontend/rpi/display.o: src/frontend/rpi/display.c
	${MKDIR} -p ${OBJECTDIR}/src/frontend/rpi
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/rpi/display.o src/frontend/rpi/display.c

${OBJECTDIR}/src/frontend/rpi/joystick.o: src/frontend/rpi/joystick.c
	${MKDIR} -p ${OBJECTDIR}/src/frontend/rpi
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/rpi/joystick.o src/frontend/rpi/joystick.c

${OBJECTDIR}/src/frontend/rpi/rpcontrol.o: src/frontend/rpi/rpcontrol.c
	${MKDIR} -p ${OBJECTDIR}/src/frontend/rpi
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/rpi/rpcontrol.o src/frontend/rpi/rpcontrol.c

${OBJECTDIR}/src/main.o: src/main.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.c
...
${TESTDIR}/tests/backend/test_board.o: tests/backend/test_board.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/backend/test_board.o tests/backend/test_board.c


${TESTDIR}/tests/backend/test_piece_actions.o: tests/backend/test_piece_actions.c 
	${MKDIR} -p ${TESTDIR}/tests/backend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/backend/test_piece_actions.o tests/backend/test_piece_actions.c


${TESTDIR}/tests/backend/test_random_gen.o: tests/backend/test_random_gen.c 
	${MKDIR} -p ${TESTDIR}/tests/backend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/backend/test_random_gen.o tests/backend/test_random_gen.c


${TESTDIR}/tests/backend/test_rwops.o: tests/backend/test_rwops.c 
	${MKDIR} -p ${TESTDIR}/tests/backend
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/backend/test_rwops.o tests/backend/test_rwops.c
...
${OBJECTDIR}/src/backend/board/board_nomain.o: ${OBJECTDIR}/src/backend/board/board.o src/backend/board/board.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/board/board_nomain.o src/backend/board/board.c;\
	else  \
...
${OBJECTDIR}/src/backend/board/pieces/piece_actions_nomain.o: ${OBJECTDIR}/src/backend/board/pieces/piece_actions.o src/backend/board/pieces/piece_actions.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/board/pieces/piece_actions_nomain.o src/backend/board/pieces/piece_actions.c;\
	else  \
...
${OBJECTDIR}/src/backend/board/random_generator_nomain.o: ${OBJECTDIR}/src/backend/board/random_generator.o src/backend/board/random_generator.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/board/random_generator_nomain.o src/backend/board/random_generator.c;\
	else  \
...
${OBJECTDIR}/src/backend/board/timer/boardTimer_nomain.o: ${OBJECTDIR}/src/backend/board/timer/boardTimer.o src/backend/board/timer/boardTimer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/board/timer/boardTimer_nomain.o src/backend/board/timer/boardTimer.c;\
	else  \
...
${OBJECTDIR}/src/backend/rw/rw_ops_nomain.o: ${OBJECTDIR}/src/backend/rw/rw_ops.o src/backend/rw/rw_ops.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/rw/rw_ops_nomain.o src/backend/rw/rw_ops.c;\
	else  \
...
${OBJECTDIR}/src/backend/stats/stats_mgmt_nomain.o: ${OBJECTDIR}/src/backend/stats/stats_mgmt.o src/backend/stats/stats_mgmt.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/backend/stats/stats_mgmt_nomain.o src/backend/stats/stats_mgmt.c;\
	else  \
...
${OBJECTDIR}/src/frontend/rpi/audioControl_nomain.o: ${OBJECTDIR}/src/frontend/rpi/audioControl.o src/frontend/rpi/audioControl.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/rpi/audioControl_nomain.o src/frontend/rpi/audioControl.c;\
	else  \
...
${OBJECTDIR}/src/frontend/rpi/display_nomain.o: ${OBJECTDIR}/src/frontend/rpi/display.o src/frontend/rpi/display.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/rpi/display_nomain.o src/frontend/rpi/display.c;\
	else  \
...
${OBJECTDIR}/src/frontend/rpi/joystick_nomain.o: ${OBJECTDIR}/src/frontend/rpi/joystick.o src/frontend/rpi/joystick.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/rpi/joystick_nomain.o src/frontend/rpi/joystick.c;\
	else  \
...
${OBJECTDIR}/src/frontend/rpi/rpcontrol_nomain.o: ${OBJECTDIR}/src/frontend/rpi/rpcontrol.o src/frontend/rpi/rpcontrol.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/frontend/rpi/rpcontrol_nomain.o src/frontend/rpi/rpcontrol.c;\
	else  \
...
${OBJECTDIR}/src/main_nomain.o: ${OBJECTDIR}/src/main.o src/main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -DRPI -I/usr/local/include `pkg-config --cflags sdl` -std=c11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main_nomain.o src/main.c;\
	else  \
